...
The seeded corpus contains **250 real, hand-curated N1 words** — genuine readings, natural example
...
隆盛↔衰退, 昇格↔降格, 依存↔自立, 頭角/秀でる/卓越/傑出/逸材) — not generated filler.
...
remaining 211 left completely unseen (plenty of headroom for the Learn flow) — plus a 42-day
...
src/
  ...
  data/           The 250-word vocabulary corpus + topic labels
