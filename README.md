...
The seeded corpus contains **600 real, hand-curated N1 words** — genuine readings, natural example
...
結束↔分裂, 本質↔表層, 虚構↔実在, 与党↔野党, 参入↔撤退, 高騰↔暴落, 虚弱↔頑健, 陰湿↔温厚,
杜撰↔几帳面) — not generated filler.
...
remaining 561 left completely unseen (plenty of headroom for the Learn flow) — plus a 42-day
...
src/
  ...
  data/           The 600-word vocabulary corpus + topic labels
